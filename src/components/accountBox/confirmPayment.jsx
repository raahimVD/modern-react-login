...
export function ConfirmPayment(props) {
    ...
    return (
        <BoxContainer>
            ...
            <SmallText>Your first payment has been successfully <br/> 
            processed and the shopkeeper is informed 
            <br />about this payment and requested him 
            <br />to complete the order. In case of any issue,
             <br />call us any time.</SmallText>
            {/* <FormContainer> */}
      ...
      <MutedLink href="#">
        ...
        <BoldLink href="#" onClick={switchToMain}>
          Signup
            ...
            <SubmitButton type="" onClick={switchToMain}>Home</SubmitButton>
        </BoxContainer>
    );
}
